...
class TemplatePanel(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.pulse_start = SIInput(100e-6, 0.0, 1000.0, "s")
        self.pulse_rise = SIInput(100e-9, 0.0, 1000.0, "s")
        self.pulse_hold = SIInput(100e-6, 0.0, 1000.0, "s")
        self.pulse_fall = SIInput(100e-9, 0.0, 1000.0, "s")
        self.pulse_total = SIInput(1e-3, 0.0, 1000.0, "s")
        self.pulse2_start = SIInput(500e-6, 0.0, 1000.0, "s")
        self.pulse2_rise = SIInput(100e-9, 0.0, 1000.0, "s")
        self.pulse2_amplitude = SIInput(-100e-3, -200.0, 200.0, "V")
        self.pulse2_hold = SIInput(100e-6, 0.0, 1000.0, "s")
        self.pulse2_fall = SIInput(100e-9, 0.0, 1000.0, "s")
